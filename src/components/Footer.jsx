...
function Footer() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "black", marginTop: "4rem" }}
    >
      <div className="container">
        <div className="row">
          <div className="col-lg-4 col-md-6">
            <div className="footer-info" style={boxStyle}>
              ...
              <div className="text-white social-links mt-3">
                <div style={{ ...socialLinkStyle }} className="social-link">
          ...
          <div className="text-light width-100 pt-4 col-lg-2 col-md-6 footer-links">
            <h6 style={{ textAlign: "left", marginLeft: "2rem" }}>
              Useful Links
            </h6>
            <ul
              style={{
          ...
          <div className="text-light pt-4 col-lg-4 col-md-6 footer-newsletter">
            ...
            <form action="" method="post">
              <input
                type="email"
                name="email"
                style={{ padding: "0.65rem", width: "300px" }}
              />
              <input
      ...
      {showBackToTop && (
        <a
          ...
          className="back-to-top d-flex  align-items-center justify-content-end active"
          onMouseEnter={(e) => {
            e.target.style.backgroundColor = "red";
            e.target.style.color = "white";
          }}
